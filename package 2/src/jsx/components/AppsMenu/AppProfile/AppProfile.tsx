...
interface galleryBlogType {
  image: string;
}
const galleryBlog: galleryBlogType[] = [
  { image: profile03 },
  { image: profile04 },
  { image: profile02 },
  { image: profile04 },
                ...
                <div className="card-body pt-3">
                  <div className="profile-blog ">
                    ...
                    <Link to="/post-details">
                      {" "}
                      <h4>
                        Proof That EDUCATION Is Exactly What You Are Looking For
                      </h4>{" "}
                    </Link>
                    <p className="mb-0">
