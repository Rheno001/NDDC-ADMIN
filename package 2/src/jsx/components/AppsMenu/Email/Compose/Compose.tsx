              ...
              <div className="row gx-0">
                <div className="col-lg-3 col-xl-2 col-xxl-3">
                  <div className="email-left-box dlab-scroll  pt-3">
                    <div className="p-0">
                      <Link to="/email-compose" className="btn text-white btn-block">
                    ...
                    <div className="mail-list rounded ">
                      <Link to="/email-inbox" className="list-group-item active">
                        ...
                        Inbox
                        <span className="badge badge-purple badge-sm float-end rounded">123</span>
                      </Link>
                      ...
                      <Link to="/email-compose" className="list-group-item">
                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path
                            d="M15.4425 10.0575L10.065 15.435C9.92569 15.5745 9.76026 15.6851 9.57816 15.7606C9.39606 15.8361
                      ...
                      <Link to="#" className="list-group-item">
                        <i className="fa-regular fa-clock align-middle"></i> Scheduled
                      </Link>
                      <Link to="#" className="list-group-item ">
                    ...
                    <div className="mail-list rounded overflow-hidden mt-4 ">
                      ...
                      <Link to="/email-inbox" className="list-group-item change">
                        Work{" "}
                      </Link>
                      <Link to="/email-inbox" className="list-group-item change">
                        Private{" "}
                  ...
                  <div className="email-right-box ms-0">
                    <div className="toolbar mb-4 px-3 mt-3" role="toolbar">
                      ...
                      <Dropdown className="btn-group mb-1">
                        <Dropdown.Toggle type="button" className="btn btn-primary light dropdown-toggle px-3 ms-1" data-toggle="dropdown">
                      ...
                      <Dropdown className="btn-group mb-1">
                        <Dropdown.Toggle className="btn btn-primary light dropdown-toggle px-3 ms-1" data-toggle="dropdown">
                    ...
                    <div className="compose-wrapper " id="compose-content">
                      <div className="compose-content">
                        <form action="#">
                          ...
                          <div className="form-group mb-3">
                            <textarea id="email-compose-editor" className="textarea_editor form-control bg-transparent" rows={5} placeholder="Enter text ..."></textarea>
                          </div>
                        </form>
                        <h5 className="my-3">
