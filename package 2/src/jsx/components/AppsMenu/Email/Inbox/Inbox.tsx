...
const messageBlog = Array(20).fill({});
...
const Inbox = () => {
  ...
  const sort = 13;
  const activePag = useRef<number>(0);

  // Active data
  const chageData = (first: number, sec: number) => {
  ...
  const chackbox =
    document.querySelectorAll<HTMLInputElement>(".message input");
  const motherChackBox = document.querySelector<HTMLInputElement>("#checkbox1");

  function chackboxFun(type: string) {
    
    Array.from(chackbox).forEach((element) => {
      if (type === "all") {    
        ...
        if (!element.checked) {
          ...
          if (Array.from(chackbox).every((el) => el.checked)) {
  ...
  return (
    <Fragment>
      <div className="card p-0 rounded-0 mb-0">
        <div className="row gx-0">
          <div className="col-xl-2 col-xxl-3 col-lg-3">
            <div className="email-left-box dlab-scroll ">
              <div className="p-0">
                    ...
                    <div className="d-flex align-items-center">
                      ...
                      >
                        ...
                        >
                          <Nav.Link
                            as="button"
                            className="btn  mx-2 effect nav-link"
