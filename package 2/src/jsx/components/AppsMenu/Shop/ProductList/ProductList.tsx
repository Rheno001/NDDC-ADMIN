...
const productData: productDataType[] = [
  {
    image: product2,
    title: "Blue blazers for girls School Uniform",
    price: "320",
  },
  {
    image: product3,
    title: "Maison deducation French School Dress",
    price: "325",
  },
  {
    image: product4,
    title: "Skirt for School kids School Uniform",
    price: "480",
  },
  {
    image: product5,
    title: "Girl with books Indian School uniform",
    price: "658",
  },
                ...
                <div className="row m-b-30">
                  ...
                  <div className="col-md-7 col-xxl-12">
                    <div className="new-arrival-content position-relative">
                      <h4>
                        <Link to="/ecom-product-detail">{item.title}</Link>
                      </h4>
                      ...
                      <p>
                        ...
                        stock <i className="fa fa-check-circle text-success" />
                      </p>
                      <p>
