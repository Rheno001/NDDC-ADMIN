...
const ProductOrder = () => {
  const chackboxFun = (type?: string) => {
    setTimeout(() => {
      const chackbox: NodeListOf<HTMLInputElement> =
        document.querySelectorAll(".product_order");
      const motherChackBox: HTMLInputElement | null = document.querySelector(
        ".product_order_single"
      );
                  ...
                  <tbody id="orders">
                    <tr className="btn-reveal-trigger">
                      ...
                      <td className="py-2">
                        ...
                        by{" "}
                        <strong className="text-primary">Ricky Antony</strong>
                        <br />
                    ...
                    <tr className="btn-reveal-trigger">
                      ...
                      <td className="py-2">
                        ...
                        by{" "}
                        <strong className="text-primary">Bucky Robert</strong>
                        <br />
                    ...
                    <tr className="btn-reveal-trigger">
                      ...
                      <td className="py-2">
                        ...
                        by{" "}
                        <strong className="text-primary">David Peters</strong>
                        <br />
