            ...
            {records.map((item, ind) => (
              <tr key={ind}>
                ...
                <td className="text-end">
                  <span
                    className={`badge badge-sm light badge-${
                      item.status === "Good" ? "success" : "danger"
                    }`}
                  >
                    {item.status}
                  </span>
