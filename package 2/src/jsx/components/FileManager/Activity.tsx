...
function Dzmedia({ image }: propType) {
  return (
    <>
      <Link to={"#"}>
        <img src={image} alt="" />
                  ...
                  <ul className="timeline-active style-1">
                    <li className="d-flex align-items-baseline timeline-list">
                      ...
                      <div className="panel">
                        ...
                        >
                          <span>
                            <strong className="text-primary">Karen Hope</strong>{" "}
                      ...
                      <div className="panel">
                        ...
                        >
                          <span>
                            ...
                            Due date of{" "}
                            <strong className="text-secondary font-w500">
                              Science Homework task will be coming
                            </strong>
                          </span>
                        </Link>
                      </div>
                    ...
                    <li className="d-flex align-items-baseline timeline-list">
                      ...
                      <div className="panel">
                        ...
                        >
                          <span>
                            <strong className="text-primary">Tony Soap </strong>{" "}
                            commented at{" "}
                            <strong className="text-secondary font-w500">
                              {" "}
                              Science Homework{" "}
                      ...
                      <div className="panel">
                        ...
                        >
                          <span className="mb-2 d-block">
                            ...
                            add 4 files on{" "}
                            <strong className="text-primary font-w500">
                              {" "}
                              Art Class{" "}
                            </strong>
                          </span>
                    ...
                    <li className="d-flex align-items-baseline last-timeline">
                      ...
                      <div className="panel">
                        ...
                        >
                          <span>
                            <strong className="text-primary">You</strong> has
                            moved{" "}
                            <strong className="text-success font-w500">
                              “Biology Homework”{" "}
                            </strong>{" "}
                            task to Done
                          </span>
                      ...
                      <div className="panel">
                        ...
                        >
                          <span>
                            ...
                            mentioned you at{" "}
                            <strong className="text-warning font-w500">
                              {" "}
                              Art Class Homework
                            </strong>
                          </span>
                      ...
                      <div className="panel">
                        ...
                        >
                          <span>
                            ...
                            mentioned you at{" "}
                            <strong className="text-primary font-w600">
