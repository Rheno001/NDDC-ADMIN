...
const DzImage = ({ image }: { image: string }) => {
  return (
...
const chatList = [
  {
    image1: course2,
    title1: "Product Team (32)",
    time1: "10.12",
    image2: course5,
    title2: "Design Team (32)",
    time2: "11.20",
  },
  {
    image1: course3,
        ...
        <div className="col-xl-3 col-xxl-4 col-md-5 chat-left-area">
          <div className="card dlab-scroll chat-sidebar rounded-0 mb-0">
            <div className="card-body">
              ...
              <Link
                to={"#"}
                className="btn btn-primary light btn-rounded btn-block"
              >
                {" "}
                View More
              </Link>
