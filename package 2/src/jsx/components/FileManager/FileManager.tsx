...
import { projectSvg1, projectSvg2, projectSvg3, projectSvg4 } from "./FileSvg";
      ...
      <div className="card p-0 rounded-0 file_area mb-0">
        <div className="row gx-0">
          <div className="col-xl-2 col-xxl-3 col-lg-3 col-md-4">
            <div
              className="email-left-box border-end  dlab-scroll"
              id="email-left"
            >
              <div className="p-0">
                <Link
                ...
                >
                  <i className="fa-solid fa-plus me-3"></i>Upload
                </Link>
              </div>
              <div className="mail-list rounded ">
                <Link to={"/email-inbox"} className="list-group-item active">
                  <i className="fa-regular fa-envelope align-middle"></i>Inbox{" "}
                  <span className="badge badge-purple badge-sm float-end rounded">
                    2
                  </span>{" "}
                </Link>
                <Link to={"#"} className="list-group-item">
                  <i className="fa-regular fa-paper-plane align-middle"></i>Sent
                </Link>
                <Link to={"#"} className="list-group-item">
                  <i className="fa-regular fa-star align-middle"></i>Favorite{" "}
                </Link>
                <Link to={"#"} className="list-group-item">
                  <i className="fa-regular fa-file align-middle"></i>Draft
                </Link>
                <Link to={"#"} className="list-group-item ">
                  <svg
                    width="18"
          ...
          <div className="col-xl-10 col-xxl-9 col-lg-9 col-md-8">
            <div className="row  gx-0">
                          ...
                          <div className="drive">
                            ...
                            <div className="drive-content">
                              ...
                              <div className="progress default-progress">
                                <div
                                  className="progress-bar bg-vigit progress-animated bg-primary"
                                  style={{
                                    width: item.progres,
                                    height: "100%",
                                  }}
                              ...
                              <span>
                                {item.subtitle1} GB / {item.subtitle2} GB
                              </span>
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="card-body py-0">
                    <div className="page-titles">
                      ...
                      <div className="d-flex my-2">
                        ...
                        <div
                          className={`d-flex align-items-center folder-layout-tab ${
                            toggle ? "grid" : ""
                          } `}
                        >
                          <div
                            className="feature-btn icon-box icon-box-sm rounded ms-2"
              ...
              <div className="col-xl-12">
                <div
                  className={`folder-structure dlab-scroll ${
                    toggle ? "grid" : ""
                  }`}
                >
                      ...
                      <div className="file-list">
                        ...
                        <div className="dz-info">
                          <Link to={"#"}>
                            ...
                            <span>
                              3 Items December 27th, 2021 04:56 AM - 10.0 MB
                            </span>
                          </Link>
                        </div>
                      </div>
