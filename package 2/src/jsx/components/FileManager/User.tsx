...
const User = () => {
  const childRef = useRef<null | HTMLElement>();
  const [addList, setAddList] = useState<contactListType[]>(contactList);
  const [load, setload] = useState<boolean>(false);

  const AddMoreData = () => {
    setload(true);
    setTimeout(() => {
      const randomIndex: number = Math.floor(Math.random() * addList.length);
      const randomItem: contactListType = addList[randomIndex];
    ...
    <>
                ...
                <div className="card-header border-0 pb-0 d-block">
                  <div className="d-flex align-items-center justify-content-between">
                    <div>
                      ...
                      <span>
                        You have <span className="font-w600">50</span> contacts
                      </span>
                    </div>
                    <button
                      type="button"
                      className="icon-box icon-box-sm bg-primary border-0"
                      // @ts-expect-error
                ...
                <div className="card-body height450 dlab-scroll pt-0 pb-0">
                  <div className="contacts-list" id="RecentActivityContent">
                    {contactList.map((data, ind) => (
                      <div
                        className="d-flex justify-content-between mb-3 mt-3 pb-3 user border-bottom"
                        key={ind}
                      >
                        <div className="d-flex align-items-center">
                          ...
                          <div className="ms-3">
                            <h5 className="mb-1">
                              <Link to={"/app-profile"}>{data.title}</Link>
                            </h5>
                ...
                <div className="card-header d-block border-0 pb-0 ">
                  <div className="d-flex justify-content-between">
                    <div>
                      ...
                      <span>
                        You have <span className="font-w600">10 New</span>{" "}
                        Messages
                      </span>
                    </div>
                    <button
                ...
                <div className="card-body height450 dlab-scroll py-0">
                  <div className="contacts-list" id="RecentMessagesContent">
                    {addList.map((data, ind) => (
                      <div
                        className="d-flex justify-content-between mb-3 mt-3 border-bottom pb-3"
                        key={ind}
                      >
                        <div className="d-flex align-items-center">
                          <img src={data.image} alt="" className="avatar" />
                          <div className="ms-3">
                            <h5 className="mb-1">
                              <Link to={"/email-inbox"}>{data.title}</Link>
                            </h5>
                            <span className="fs-14 text-muted text-wrap">
            ...
            <div className="card-body">
              <ul className="d-flex align-items-baseline justify-content-between mb-3">
                ...
                <li className="text-white">
                  Your Plan<h3 className="text-white">Free</h3>
                </li>
                <li>
                  <Dropdown className="custom-dropdown">
                    <Dropdown.Toggle
              ...
              <div className="dz-scroll">
                <ul className="timeline-active">
                  <li className="d-flex timeline-list">
                    ...
                    <div className="panel">
                      <Link
                        className="timeline-panel text-muted d-flex align-items-center mb-0"
                        to="#"
                      >
                        <span>
                          <strong className="">Karen Hope</strong> moved task{" "}
                          <strong className="text-secondary font-w500">
                            “User Research“
                          </strong>
                          from On Progress to Done{" "}
                        </span>
                      </Link>
                    ...
                    <div className="panel">
                      ...
                      >
                        <span>
                          ...
                          <strong className="text-primary"> 4 </strong>attached
                          files on task
                          <strong className="text-warning fonr-w500">
                            “Photo’s Assets“
                          </strong>
                        </span>
                      </Link>
                    ...
                    <div className="panel">
                      ...
                      >
                        <span className="mb-0">
                          ...
                          Frize{" "}
                          <strong className="text-danger font-w500">
                            Projects{" "}
                          </strong>
                        </span>
                      </Link>
      ...
      >
        <div className="modal-header">
          <h1 className="modal-title fs-5" id="exampleModalLabel-1">
            New Message
          </h1>
          <button
            type="button"
