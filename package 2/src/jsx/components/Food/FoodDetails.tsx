            ...
            <ul className="d-sm-flex d-block align-items-start justify-content-between mb-5">
              ...
              <li>
                <Dropdown className="custom-dropdown">
                  <Dropdown.Toggle
                    as="div"
                    className="i-false btn sharp  btn-light"
                  >
                    {SVGICON.dots}
                  </Dropdown.Toggle>
            ...
            <div className="row">
              <div className="col-xl-2 col-lg-3 col-md-2 col-6 mb-md-0 mb-3">
                <ul>
                  <li>Rating</li>
                  <li>
                    <i className="fa fa-star text-warning fs-20 me-2"></i>
                    <Link to={"#"} className="heading m-0 text-primary">
                      4.9
                    </Link>
                  </li>
                </ul>
                ...
                <ul className="food-recipe">
                  {inputBlog.map((item, ind) => (
                    <div className="form-check" key={ind}>
                      ...
                      />
                      <label
                        className="form-check-label font-w400"
                        htmlFor={item.inputid2}
                      >
                        {item.lable2}
                      </label>
                    </div>
              ...
              <div className="stud-comment">
                ...
                <div>
                  <span className="d-block mt-2 mb-3">
                    Sed eligendi facere repellendus. Ipsam ipsam incidunt minima
                    harum tenetur.
                  </span>
                </div>
                <ul className="d-flex align-items-center">
          ...
          <Tab.Container defaultActiveKey={"All"}>
            <div className="card-header border-0 pb-0 flex-wrap">
              ...
              <Nav as="ul" className="nav nav-tabs food-tabs">
                <Nav.Item as="li">
                  <Nav.Link eventKey={"All"} id="home-tab">
                    All Means
                  </Nav.Link>
                </Nav.Item>
                          ...
                          <tr key={ind}>
                            <td style={{ width: "100px" }}>
                              <div className="food-menu">
                                <img
                                  className="me-3 rounded avatar avatar-xl"
                                  src={item.image}
                                  alt="DexignZone"
                                />
                            ...
                            <td>
                              <ul className="food-review">
                                ...
                                <li>
                                  <h5 className="font-w700">{item.rating}</h5>
                                </li>
                              </ul>
                            </td>
                            <td>
                              <ul className="d-flex">
                                ...
                                <li>
                                  <h3 className="mb-0 font-w500 fs-22">
                                    {item.sales}
                                  </h3>
