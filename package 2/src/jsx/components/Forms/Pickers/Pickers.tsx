...
const Pickers: React.FC = () => {
  const [colorChange, setColorChange] = useState<string | null>(null);
  const [startDate, setStartDate] = useState<Date>(new Date("2024/05/08"));
  const [endDate, setEndDate] = useState<Date>(new Date("2024/05/10"));
