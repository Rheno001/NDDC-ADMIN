...
const Teachers = () => {
  ...
  const [contacts, setContacts] = useState<blogType[]>(CardListBlog);
  // delete data
  ...
  //Add data
  const [addFormData, setAddFormData] = useState<formType>({
    Post: "",
    Cust_Name: "",
    Subject: "",
    image: "",
  ...
  const handleAddFormChange = (e: FormEvent) => {
    e.preventDefault();
    const event = e.target as HTMLInputElement;
    const fieldName = event.getAttribute("name");
    const fieldValue: string = event.value;
  ...
  const handleEditClick = (event: MouseEvent, contact: blogType) => {
    event.preventDefault();
  ...
  const handleEditFormChange = (event: FormEvent) => {
    event.preventDefault();
  ...
  const fileHandler = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (target.files && target.files[0]) {
      ...
      reader.onload = () => {
        const src = reader.result as string; // The base64 string of the image
        addFormData.image = src; // Assign the base64 image to `addFormData.image`
      };
      reader.readAsDataURL(target.files[0]); // Convert file to base64
    }
  };
                ...
                <div className="card-body">
                  <div className="user-content">
                    ...
                    <Dropdown>
                      <Dropdown.Toggle
                        as="div"
                        className="btn sharp btn-light i-false"
                      >
                        <svg
                          width="24"
                          height="6"
                  ...
                  <div className="contact-icon">
                    ...
                    <span className="badge badge-secondary light mx-2">
                      Science
                    </span>
                  ...
                  <div className="d-flex align-items-center">
                    ...
                    >
                      <i className="fa-sharp fa-regular fa-envelope me-2"></i>
                      Chat
                    </Link>
                  </div>
                </div>
