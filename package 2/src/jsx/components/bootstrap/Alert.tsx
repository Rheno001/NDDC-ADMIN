                        ...
                        <Tab.Pane eventKey="Preview">
                          <Card.Body>              
                            ...
                            <Alert
                              variant="primary"
                              dismissible
                              show={state.basicprimary}
                            >
                              {emojis.welcome}
                              <strong>Welcome! </strong> Message has been sent.
                              <button
                                className="btn-close"
                                onClick={() => dispatch({ type: "basicprimary" })}
                              >
                                <span>
                            ...
                            <Alert
                              variant="secondary"
                              dismissible
                              show={state.basicsecondary}
                            >
                              {emojis.done}
                              <strong>Done! </strong> Your profile photo updated.
                              <button
                                className="btn-close"
                                onClick={() => dispatch({ type: "basicsecondary" })}
                              >
                                <span>
                                  <i className="fa-solid fa-xmark"></i>
                                </span>
                            ...
                            <Alert
                              variant="success"
                              dismissible
                              show={state.basicsuccess}
                            >
                              {emojis.success}
                              <strong>Success! </strong> Message has been sent.
                              <button
                                className="btn-close"
                                onClick={() => dispatch({ type: "basicsuccess" })}
                              >
                                <span>
                            ...
                            <Alert variant="info" dismissible show={state.basicinfo}>
                              {emojis.info}
                              <strong>Info! </strong> You have got 5 new email.
                              <button
                                className="btn-close"
                                onClick={() => dispatch({ type: "basicinfo" })}
                              >
                                <span>
                                  <i className="fa-solid fa-xmark"/>
                                </span>
                            ...
                            >
                              ...
                              <button
                                className="btn-close"
                                onClick={() => dispatch({ type: "basicwarning" })}
                              >
                                <span>
                                  <i className="fa-solid fa-xmark"/>
                                </span>
                            ...
                            <Alert
                              variant="danger"
                              dismissible
                              show={state.basicdanger}
                            >
                              {emojis.error}
                              <strong>Error! </strong> Message sending failed.
                              <button
                                className="btn-close"
                                onClick={() => dispatch({ type: "basicdanger" })}
                              >
                                <span>
                                  <i className="fa-solid fa-xmark"/>
                                </span>
                            ...
                            <Alert variant="dark" dismissible show={state.basicdark}>
                              {emojis.error}
                              <strong>Error! </strong> You successfully read this
                              important alert message.
                              <button
                                className="btn-close"
                                onClick={() => dispatch({ type: "basicdark" })}
                              >
                                <span>
                                  <i className="fa-solid fa-xmark"/>
                                </span>
                            ...
                            <Alert variant="light" dismissible show={state.basiclight}>
                              {emojis.error}
                              <strong>Error! </strong> You successfully read this
                              message..
                              <button
                                className="btn-close"
                                onClick={() => dispatch({ type: "basiclight" })}
                              >
                                <span>
                                  <i className="fa-solid fa-xmark"/>
                                </span>
                          ...
                          <div className="card-body pt-0 p-0 code-area">
                            <pre className="mb-0">
                              <code className="language-html">
                                <Highlight>
                                  {`
  <Alert  variant="primary" dismissible show={state.basicprimary}>
    {emojis.welcome}
    <strong>Welcome! </strong> Message has been sent. 
    <button className="btn-close" onClick={()=>dispatch({type:'basicprimary'})}><span><i className="fa-solid fa-xmark"></i></span></button>
  </Alert>
  <Alert  variant="secondary" dismissible show={state.basicsecondary}>
    {emojis.done}
    <strong>Done! </strong> Your profile photo updated. 
    <button className="btn-close" onClick={()=>dispatch({type:'basicsecondary'})}><span><i className="fa-solid fa-xmark"></i></span></button>
  </Alert>
  <Alert  variant="success" dismissible show={state.basicsuccess}>
    {emojis.success}
    <strong>Success! </strong> Message has been sent. 
    <button className="btn-close" onClick={()=>dispatch({type:'basicsuccess'})}><span><i className="fa-solid fa-xmark"></i></span></button>
  </Alert>
  <Alert  variant="info" dismissible show={state.basicinfo}>
    {emojis.info}
    <strong>Info!  </strong> You have got 5 new email. 
    <button className="btn-close" onClick={()=>dispatch({type:'basicinfo'})}><span><i className="fa-solid fa-xmark"></i></span></button>
  </Alert>
  <Alert  variant="warning" dismissible show={state.basicwarning}>
    {emojis.error}
    <strong>Error! </strong> Something went wrong. Please check.
    <button className="btn-close" onClick={()=>dispatch({type:'basicwarning'})}><span><i className="fa-solid fa-xmark"></i></span></button>
  </Alert>
  <Alert  variant="danger" dismissible show={state.basicdanger}>
    {emojis.error}
    <strong>Error! </strong> Message sending failed.
    <button className="btn-close" onClick={()=>dispatch({type:'basicdanger'})}><span><i className="fa-solid fa-xmark"></i></span></button>
  </Alert>
  <Alert  variant="dark" dismissible show={state.basicdark}>
    {emojis.error}
    <strong>Error!  </strong> You successfully read this important alert message.
    <button className="btn-close" onClick={()=>dispatch({type:'basicdark'})}><span><i className="fa-solid fa-xmark"></i></span></button>
  </Alert>
  <Alert  variant="light" dismissible show={state.basiclight}>
    {emojis.error}
    <strong>Error!  </strong> You successfully read this message..
    <button className="btn-close" onClick={()=>dispatch({type:'basiclight'})}><span><i className="fa-solid fa-xmark"></i></span></button>
  </Alert>
  `}
                                </Highlight>
                              </code>
                  ...
                  <Card id="color-alerts" className="dz-card">
                    <Card.Header className="d-flex justify-content-between flex-wrap">
                      <div>
                        ...
                        <Card.Text className="subtitle mb-0">
                          add <code>.solid</code> class to change the solid
                          color.
                        </Card.Text>
                      </div>
                      <Nav
                    ...
                    <Card.Header className="d-flex justify-content-between flex-wrap">
                      <div>
                        ...
                        <p className="mb-0 subtitle">
                          add <code>.alert-square</code> class to change the
                          solid color.
                        </p>
                      </div>
                      <Nav
                        ...
                        <Card.Body>
                          ...
                          >
                            ...
                            <button
                              className="btn-close"
                              onClick={() =>
                                dispatch({ type: "altsolidsecondary" })
                              }
                            >
                              <span>
                                <i className="fa-solid fa-xmark"></i>
                        ...
                        <Card.Body>
                          ...
                          >
                            ...
                            <button
                              className="btn-close"
                              onClick={() =>
                                dispatch({ type: "soliddissecondary" })
                              }
                            >
                              <span>
                                <i className="fa-solid fa-xmark"></i>
                      ...
                      <Tab.Pane eventKey="Preview">
                        <Card.Body>
                          ...
                          >
                            ...
                            <Link
                              to={"#"}
                              className="badge-sm light ms-1 badge badge-info"
                            >
                              upgrade
                            </Link>
                            <button
                          ...
                          >
                            ...
                            <Link
                              to={"#"}
                              className="badge-sm light ms-1 badge badge-dark"
                            >
                              upgrade
                            </Link>
                            <button
                            ...
                            <Col xl={6}>
                              <Alert variant="primary" className="notification">
                                ...
                                <p>
                                  ...
                                  recently moved to center stage-at lease it
                                  seems that way.
                                </p>
                      ...
                      <Tab.Pane eventKey="Preview">
                        <Card.Body>
                          ...
                          >
                            ...
                            Error! You successfully read this important alert
                            message.
                            <button
                              className="btn-close"
                    ...
                    <Card.Header className="d-flex justify-content-between flex-wrap">
                      <div>
                        ...
                        <p className="mb-0 subtitle">
                          add{" "}
                          <code>
                            .alert-outline-primary,secondary,success...
                          </code>{" "}
                          to change the style
                        </p>
                      </div>
                        ...
                        <Card.Body>
                          ...
                          >
                            ...
                            <button
                              className="btn-close"
                              onClick={() =>
                                dispatch({ type: "outlinesecondary" })
                              }
                            >
                              <span>
                                <i className="fa-solid fa-xmark"></i>
                            ...
                            <Col xl={6}>
                              ...
                              >
                                <button
                                  className="btn-close"
                                  onClick={() =>
                                    dispatch({ type: "messagesecondary" })
                                  }
                                >
                                  <span>
                                    <i className="fa-solid fa-xmark"></i>
                            ...
                            <Col xl={6}>
                              ...
                              >
                                <button
                                  className="btn-close"
                                  onClick={() =>
                                    dispatch({ type: "solidmessageprimary" })
                                  }
                                >
                                  <span>
                                    <i className="fa-solid fa-xmark"></i>
                            ...
                            <Col xl={6}>
                              ...
                              >
                                <button
                                  className="btn-close"
                                  onClick={() =>
                                    dispatch({ type: "solidmessagesuccess" })
                                  }
                                >
                                  <span>
                                    <i className="fa-solid fa-xmark"></i>
                            ...
                            <Col xl={6}>
                              ...
                              >
                                <button
                                  className="btn-close"
                                  onClick={() =>
                                    dispatch({ type: "solidmessageinfo" })
                                  }
                                >
                                  <span>
                                    <i className="fa-solid fa-xmark"></i>
                            ...
                            <Col xl={6}>
                              ...
                              >
                                <button
                                  className="btn-close"
                                  onClick={() =>
                                    dispatch({ type: "solidmessagewarning" })
                                  }
                                >
                                  <span>
                                    <i className="fa-solid fa-xmark"></i>
                            ...
                            <Col xl={6}>
                              ...
                              >
                                <button
                                  className="btn-close"
                                  onClick={() =>
                                    dispatch({ type: "solidmessagedanger" })
                                  }
                                >
                                  <span>
                                    <i className="fa-solid fa-xmark"></i>
                            ...
                            <Col xl={6}>
                              ...
                              >
                                <button
                                  className="btn-close"
                                  onClick={() =>
                                    dispatch({ type: "solidmessagedark" })
                                  }
                                >
                                  <span>
                                    <i className="fa-solid fa-xmark"></i>
                            ...
                            <Col xl={6}>
                              ...
                              >
                                <button
                                  className="btn-close"
                                  onClick={() =>
                                    dispatch({ type: "solidmessagelight" })
                                  }
                                >
                                  <span>
                                    <i className="fa-solid fa-xmark"></i>
