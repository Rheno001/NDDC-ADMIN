            ...
            <Row>
              <Col xl="12">
                <Tab.Container defaultActiveKey="Preview">
                  <Card className="dz-card" id="basic-list">
                    <Card.Header>
                      <div>
...
`}
              ...
              <Col xl="12">
                <Tab.Container defaultActiveKey="Preview">
                  <Card className="dz-card" id="list-active">
                    <Card.Header>
                      <div>
...
`}
              ...
              <Col xl="12">
                <Tab.Container defaultActiveKey="Preview">
                  <Card className="dz-card" id="list-disabled">
                    <Card.Header>
                      <div>
...
`}
              ...
              <Col xl="12">
                <Tab.Container defaultActiveKey="Preview">
                  <Card className="dz-card" id="link-button">
                    <Card.Header>
                      <div>
...
`}
              ...
              <Col xl="12">
                <Tab.Container defaultActiveKey="Preview">
                  <Card className="dz-card" id="flush">
                    <Card.Header>
                      <div>
...
`}
              ...
              <Col xl="12">
                <Tab.Container defaultActiveKey="Preview">
                  <Card className="dz-card" id="with-badges">
                    <Card.Header>
                      <div>
...
`}
              ...
              <Col xl="12">
                <Tab.Container defaultActiveKey="Preview">
                  <Card className="dz-card" id="custom-content">
                    <Card.Header>
                      <div>
...
`}
              ...
              <Col xl="12">
                <Tab.Container defaultActiveKey="Preview">
                  <Card className="dz-card" id="contextual">
                    <Card.Header>
                      <div>
...
`}
            ...
            <Row>
              <div className="col-lg-12">
                <Tab.Container defaultActiveKey="Preview">
                  <Card className="dz-card" id="list-tab">
                    <Card.Header>
                      <div>
                                  ...
                                  <Tab.Content>
                                    <Tab.Pane eventKey="#home">
                                      ...
                                      <p>
                                        ...
                                        adipisicing exercitation fugiat tempor.
                                        Voluptate deserunt sit sunt nisi aliqua
                                        fugiat proident ea ut. Mollit voluptate
                                        reprehenderit occaecat nisi ad non minim
                                        tempor sunt voluptate consectetur
                                        exercitation id ut nulla. Ea et fugiat
                                        aliquip nostrud sunt incididunt
                                        consectetur culpa aliquip eiusmod dolor.
                                    ...
                                    <Tab.Pane eventKey="#profile">
                                      ...
                                      <p>
                                        Cupidatat quis ad sint excepteur laborum
                                        in esse qui. Et excepteur consectetur ex
                                        nisi eu do cillum ad laborum. Mollit et
                                        eu officia dolore sunt Lorem culpa qui
                                        commodo velit ex amet id ex. Officia
                                        anim incididunt laboris deserunt anim
                                        aute dolor incididunt veniam aute dolore
                                        do exercitation. Dolor nisi culpa ex ad
                                    ...
                                    <Tab.Pane eventKey="#messages">
                                      ...
                                      <p>
                                        ...
                                        exercitation do nostrud commodo
                                        reprehenderit aute ipsum voluptate.
                                        Irure Lorem et laboris nostrud amet
                                        cupidatat cupidatat anim do ut velit
                                        mollit consequat enim tempor.
                                        Consectetur est minim nostrud nostrud
                                        consectetur irure labore voluptate
                                        irure. Ipsum id Lorem sit sint voluptate
                                        est pariatur eu ad cupidatat et deserunt
                                        culpa sit eiusmod deserunt. Consectetur
                                        et fugiat anim do eiusmod aliquip nulla
                                    ...
                                    <Tab.Pane eventKey="#settings">
                                      ...
                                      <p>
                                        ...
                                        laboris sunt dolor. Nisi eu minim cillum
                                        occaecat aute est cupidatat aliqua
                                        labore aute occaecat ea aliquip sunt
                                        amet. Aute mollit dolor ut exercitation
                                        irure commodo non amet consectetur quis
                                        amet culpa. Quis ullamco nisi amet qui
                                        aute irure eu. Magna labore dolor quis
                                        ex labore id nostrud deserunt dolor
                                        eiusmod eu pariatur culpa mollit in
                                        irure.
                                      </p>
                                    </Tab.Pane>
                                  </Tab.Content>
...
`}
        ...
        <div className="demo-right ">
          <div className="demo-right-inner dlab-scroll " id="right-sidebar">
            <h4 className="title">Examples For List Group</h4>
