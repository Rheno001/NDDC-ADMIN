...
interface State {
  ...
  modalWithTooltip: boolean;
  gridInsideModal: boolean;
  largeModal: boolean;
  smallModal: boolean;
}
...
const initialState: State = {
  ...
  contentModal: false,
  modalCentered: false,
  modalWithTooltip: false,
  gridInsideModal: false,
  largeModal: false,
  smallModal: false,
};
  ...
  return (
    <div className="h-80">
            ...
            <Card.Body>
              ...
              <div className="bootstrap-modal">
                ...
                <Button
                  variant="primary"
                  className="mb-2 me-1"
                  onClick={() => dispatch({ type: "modalWithTooltip" })}
                >
                  Modal with tooltip
                </Button>
                ...
                <Button
                  variant="primary"
                  className="mb-2 me-1"
                  onClick={() => dispatch({ type: "gridInsideModal" })}
                >
                  Grid Inside Modal
                </Button>
      ...
      <Modal
        ...
        onHide={() => dispatch({ type: "contentModal" })}
      >
        <Modal.Header>
          <Modal.Title>Modal title</Modal.Title>
          <Button
      ...
      <Modal
        className="fade"
        show={state.gridInsideModal}
        onHide={() => dispatch({ type: "gridInsideModal" })}
      >
        <Modal.Header>
          <Modal.Title>Modal title</Modal.Title>
          <Button
      ...
      <Modal
        ...
        size="sm"
        show={state.smallModal}
        onHide={() => dispatch({ type: "smallModal" })}
      >
        <Modal.Header>
          <Modal.Title>Modal title</Modal.Title>
          <Button
