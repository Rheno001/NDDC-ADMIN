      ...
      <Row>
        ...
        <Col xl={6} lg={6}>
          <Card>
            ...
            <Card.Body>
              <Sparklines data={sampleData}>
                <SparklinesLine color="#4d44b5" style={{ fill: "none" }} />
                <SparklinesSpots />
              </Sparklines>
            </Card.Body>
          </Card>
        ...
        <Col xl={6} lg={6}>
          <Card>
            ...
            <Card.Body>
              <Sparklines data={sampleData}>
                <SparklinesLine color="#4d44b5 " />
                <SparklinesSpots style={{ fill: "#4d44b5 " }} />
              </Sparklines>
            </Card.Body>
          </Card>
        </Col>
        <Col xl={6} lg={6}>
          <Card>
            ...
            <Card.Body>
              <Sparklines data={sampleData}>
                <SparklinesBars
                  style={{ fill: "#4d44b5", fillOpacity: ".6" }}
                />
                <SparklinesReferenceLine />
              </Sparklines>
            </Card.Body>
        ...
        <Col xl={6} lg={6}>
          <Card>
            ...
            <Card.Body>
              ...
              >
                <SparklinesBars style={{ fill: "#4d44b5" }} />
              </Sparklines>
            </Card.Body>
          </Card>
        </Col>
