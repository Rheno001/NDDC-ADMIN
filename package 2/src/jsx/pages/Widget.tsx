        ...
        <div className="col-xl-4 col-xxl-6 col-lg-6">
          <div className="card">
            ...
            <div className="card-body p-0">
              <div
                id="DZ_W_TimeLine"
                className="widget-timeline dlab-scroll height370 my-4 px-4"
              >
        ...
        <div className="col-xl-4 col-xxl-6 col-lg-6">
          <div className="card">
            ...
            <div className="card-body p-0">
              <div
                id="DZ_W_Todo1"
                className="widget-media dlab-scroll height370 my-4 px-4"
              >
                <ul className="timeline">
                  <li>
            ...
            <div className="card-body  p-4">
              <div className="media">
                ...
                <div className="media-body text-white text-end">
                  <p className="mb-1 text-white">Appointment</p>
          ...
          <div className="widget-stat card bg-success">
            <div className="card-body p-4">
              <div className="media">
                ...
                <div className="media-body text-white text-end">
                  <p className="mb-1 text-white">Earning</p>
          ...
          <div className="widget-stat card bg-info">
            <div className="card-body p-4">
              <div className="media">
                ...
                <div className="media-body text-white text-end">
                  <p className="mb-1 text-white">Total Patient</p>
          ...
          <div className="widget-stat card bg-primary">
            <div className="card-body p-4">
              <div className="media">
                ...
                <div className="media-body text-white text-end">
                  <p className="mb-1 text-white">Chef</p>
                  <h3 className="text-white">$76</h3>
                </div>
              </div>
            </div>
            ...
            <div className="card-body  p-4">
              <div className="media">
                ...
                <div className="media-body text-white">
                  <p className="mb-1 text-white">Total Students</p>
          ...
          <div className="widget-stat card bg-warning">
            <div className="card-body p-4">
              <div className="media">
                ...
                <div className="media-body text-white">
                  <p className="mb-1 text-white ">New Students</p>
          ...
          <div className="widget-stat card bg-secondary">
            <div className="card-body p-4">
              <div className="media">
                ...
                <div className="media-body text-white">
                  <p className="mb-1 text-white">Total Course</p>
          ...
          <div className="widget-stat card bg-danger ">
            <div className="card-body p-4">
              <div className="media">
                ...
                <div className="media-body text-white">
                  <p className="mb-1 text-white">Fees Collect</p>
