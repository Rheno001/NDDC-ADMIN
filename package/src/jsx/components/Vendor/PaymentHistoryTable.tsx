...
const tableData: PaymentDataType[] = [
  { id: "1", date: "03 March 2023", amount: "50,036", status: "Complete" },
  { id: "2", date: "07 May 2023", amount: "40,010", status: "Canceled" },
  { id: "3", date: "05 Apr 2023", amount: "30,050", status: "Complete" },
  { id: "4", date: "10 June 2023", amount: "20,070", status: "Canceled" },
  { id: "5", date: "03 March 2023", amount: "50,036", status: "Complete" },
  { id: "6", date: "07 May 2023", amount: "40,010", status: "Canceled" },
  { id: "7", date: "05 Apr 2023", amount: "30,050", status: "Complete" },
  { id: "8", date: "10 June 2023", amount: "20,070", status: "Canceled" },
  { id: "9", date: "05 July 2023", amount: "30,050", status: "Complete" },
];
  ...
  const columns = useMemo<ColumnDef<PaymentDataType>[]>(() => [
    {
      ...
      cell: ({ row }: { row: Row<PaymentDataType> }) => (
        <div className="d-flex align-items-center">
          ...
          <div className="ms-3">
            <h6 className="mb-0 font-w600">#{Number(row.original.id) + 12345678}</h6>
          </div>
        </div>
      ),
    },
    {
      ...
      accessorKey: "date",
      cell: ({ row }: { row: Row<PaymentDataType> }) => (
        <span>{row.original.date}, 13:45 PM</span>
      ),
    },
    {
      header: "Amount",
      accessorKey: "amount",
      cell: ({ row }: { row: Row<PaymentDataType> }) => (
        <span className="doller font-w600"> $ {row.original.amount}</span>
      ),
    },
    {
      header: "Status",
      accessorKey: "status",
      cell: ({ row }: { row: Row<PaymentDataType> }) => (
        <span className={`font-w600 text-${row.original.status === "Canceled" ? "danger" : "success"} `}>{row.original.status}</span>
      ),
    },
  ], []);
